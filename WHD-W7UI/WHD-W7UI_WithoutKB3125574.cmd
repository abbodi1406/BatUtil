...
echo ============================================================
md "%cab_dir%\Hotfix"
if /i "%CEdition%" equ "Enterprise" if exist "%target%\Windows\fr-fr\explorer.exe.mui" if exist "Extra\WithoutKB3125574\SL\French.Enterprise\*%arch%*.msu" (copy Extra\WithoutKB3125574\SL\French.Enterprise\*%arch%*.msu "%cab_dir%\Hotfix" >nul)
